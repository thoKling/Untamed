package dev.untamed.integration.registry;

import dev.untamed.Untamed;
import dev.untamed.integration.block.SurvivalTorchBlock;
import dev.untamed.integration.block.SurvivalWallTorchBlock;
import dev.untamed.integration.item.UnlitTorchItem;
...
public final class ModBlocks {
    ...
    private static <T extends Block> T register(String name,
        ...
        ResourceKey<Block> key = ResourceKey.create(Registries.BLOCK, Untamed.id(name));
        T block = factory.apply(properties.setId(key));
        return Registry.register(BuiltInRegistries.BLOCK, key, block);
    }

    private static Item registerTorchItem() {
        ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, Untamed.id(TORCH_ID));
    ...
    private static Item registerUnlitTorchItem() {
        ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, Untamed.id(UNLIT_TORCH_ID));
    ...
    public static void register() {
        ...
        Untamed.LOGGER.debug("Registered survival fire blocks");
    }
}
