package dev.untamed.launcher.branding

import dev.untamed.launcher.BuildInfo
...
object Branding {
    ...
    const val PRODUCT_NAME: String = "Untamed"
     ...
     */
    const val LAUNCHER_BRAND: String = "untamed-launcher"
