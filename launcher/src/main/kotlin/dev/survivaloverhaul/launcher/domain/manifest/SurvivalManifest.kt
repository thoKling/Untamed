package dev.survivaloverhaul.launcher.domain.manifest
...
/**
 * The whole description of one Survival Overhaul release: which Minecraft and
...
data class SurvivalManifest(
    ...
    fun problems(): List<String> = buildList {
        ...
        if (mod.version != game.survivalOverhaulVersion) {
