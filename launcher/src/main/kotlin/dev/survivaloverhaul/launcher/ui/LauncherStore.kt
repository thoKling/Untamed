...
import dev.survivaloverhaul.launcher.application.diagnostics.DiagnosticsReport
...
import dev.survivaloverhaul.launcher.application.installation.InstallationPlanner
...
import dev.survivaloverhaul.launcher.application.launch.LaunchOutcome
import dev.survivaloverhaul.launcher.application.settings.SettingsStore
...
import dev.survivaloverhaul.launcher.domain.installation.InstallationPlan
import dev.survivaloverhaul.launcher.domain.installation.InstallationSnapshot
import dev.survivaloverhaul.launcher.domain.installation.InstallationStep
import dev.survivaloverhaul.launcher.domain.java.JavaRuntimes
import dev.survivaloverhaul.launcher.domain.java.JavaSelection
import dev.survivaloverhaul.launcher.domain.settings.LaunchBehaviour
