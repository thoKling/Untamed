...
import dev.survivaloverhaul.launcher.application.launch.GameLaunchPlanner
import dev.survivaloverhaul.launcher.application.launch.LaunchPreparation
...
class GameLaunchPlannerTest {
    ...
    fun `fills every placeholder the version document names`() {
        ...
        assertContains(arguments, "-Dminecraft.launcher.brand=survival-overhaul-launcher")
        assertContains(
            arguments,
    ...
    private fun prepare(
        ...
        layout = layout,
        platform = platform,
        launcherName = "survival-overhaul-launcher",
